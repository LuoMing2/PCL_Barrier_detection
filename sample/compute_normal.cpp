...
int main(int argc, char **argv)
{
    ...
    // n.setViewPoint(-1100, -950, 0);
	n.setKSearch(100);//点云法向计算时，需要所搜的近邻点大小
	// n.setRadiusSearch(0.5);//半径搜素
	...
	viewer->addPointCloudNormals<pcl::PointXYZ, pcl::Normal>(cloud, normals, 1, 0.8, "normals");
	//设置点云大小
